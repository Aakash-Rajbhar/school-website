  ...
  return (
    <div className="bg-gray-100 min-h-screen p-8">
      <div className="max-w-6xl mx-auto bg-white shadow-lg rounded-lg overflow-hidden">
        <div className="p-6">
          <h1 className="text-4xl font-bold text-center text-gray-800 mb-8">Students</h1>

          {/* Extracurricular Activities */}
          <section className="mb-8">
            <h2 className="text-3xl font-bold text-gray-800 mb-4">Extracurricular Activities</h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {extracurricularActivities.map((activity, index) => (
                <div key={index} className="bg-white p-6 rounded-lg shadow-md">
                  <h3 className="text-2xl font-semibold text-gray-800 mb-2">{activity}</h3>
                  <p className="text-lg text-gray-700">Engage in various activities to enhance skills and creativity outside the classroom.</p>
                </div>
              ))}
            </div>
          </section>
          ...
          {/* Clubs and Societies */}
          <section className="mb-8">
            <h2 className="text-3xl font-bold text-gray-800 mb-4">Clubs and Societies</h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {clubsAndSocieties.map((club, index) => (
                <div key={index} className="bg-white p-6 rounded-lg shadow-md">
                  <h3 className="text-2xl font-semibold text-gray-800 mb-2">{club}</h3>
                  <p className="text-lg text-gray-700">Join a club or society to connect with like-minded peers and pursue your interests.</p>
                </div>
              ))}
            </div>
          </section>
          ...
          <section className="mb-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {achievements.map((achievement, index) => (
                <div key={index} className="bg-white p-6 rounded-lg shadow-md">
                  <h3 className="text-2xl font-semibold text-gray-800 mb-2">{achievement.name}</h3>
                  <p className="text-lg text-gray-700">{achievement.achievement}</p>
                </div>
              ))}
            </div>
          </section>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {studentCouncil.map((member, index) => (
                <div key={index} className="bg-white p-6 rounded-lg shadow-md">
                  ...
                  <h3 className="text-2xl font-semibold text-gray-800 mb-2">{member.position}</h3>
                  <p className="text-lg font-semibold text-gray-800">{member.name}</p>
                  <p className="text-lg text-gray-700"><strong>Grade:</strong> {member.grade}</p>
                </div>
              ))}
            </div>
          </section>
